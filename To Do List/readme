...
I have made this project using HTML,CSS,JavaScript and Bootstrap.
...
4️⃣ Bootstrap: Bootstrap, a powerful front-end framework, played a crucial role in ensuring responsiveness and mobile-friendliness of the to-do list. I utilized Bootstrap's pre-built components and grid system to create a user-friendly interface that adapts to different screen sizes.
